		...
		requirejs: {
			...
			recommender: {
				options: {
					...
					preserveLicenseComments: false,
					baseUrl: './app/',
					out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.recommender.js',
					mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
					paths: {
						'moment': '../bower_components/momentjs/min/moment.min',
						'fastclick': '../bower_components/fastclick/lib/fastclick'
					...
					include: [
						'lehu.helpers',
						'lehu.h5.page.recommender'
					],
					insertRequire: ['lehu.h5.page.recommender']
				}
			},
			registerhelp: {
				options: {
			...
			userInstructions: {
				options: {
					...
					preserveLicenseComments: false,
					baseUrl: './app/',
					out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.userInstructions.js',
					mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
					paths: {
						'moment': '../bower_components/momentjs/min/moment.min',
						'fastclick': '../bower_components/fastclick/lib/fastclick'
					...
					include: [
						'lehu.helpers',
						'lehu.h5.page.userInstructions'
					],
					insertRequire: ['lehu.h5.page.userInstructions']
				}
			},
			service: {
				options: {
					...
					preserveLicenseComments: false,
					baseUrl: './app/',
					out: './<%= config.tmp %>/concat/scripts/lehu.h5.page.service.js',
					mainConfigFile: "./<%= config.app %>/scripts/lehu.h5.require.config.js",
					paths: {
						'moment': '../bower_components/momentjs/min/moment.min',
						'fastclick': '../bower_components/fastclick/lib/fastclick'
					...
					include: [
						'lehu.helpers',
						'lehu.h5.page.service'
					],
					insertRequire: ['lehu.h5.page.service']
				}
			},
			love: {
				options: {
